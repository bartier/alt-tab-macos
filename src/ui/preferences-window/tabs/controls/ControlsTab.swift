...
class ControlsTab {
    ...
    static func initTab() -> NSView {
        ...
        let (holdShortcut4, nextWindowShortcut4, tab4View) = shortcutTab(Preferences.gestureIndex)
        ...
        [holdShortcut, holdShortcut2, holdShortcut3, holdShortcut4].forEach { ControlsTab.shortcutChangedCallback($0[1] as! NSControl) }
        [nextWindowShortcut, nextWindowShortcut2, nextWindowShortcut3, nextWindowShortcut4].forEach { ControlsTab.shortcutChangedCallback($0[0] as! NSControl) }
